 ...
 */
final class Version20260305084559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ai_objective_report (id INT AUTO_INCREMENT NOT NULL, objectif_id INT NOT NULL, content LONGTEXT NOT NULL, risk_score INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_62190510157D1AD4 (objectif_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE crypto (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, symbol VARCHAR(255) NOT NULL, apiid VARCHAR(255) NOT NULL, currentprice NUMERIC(20, 8) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE expense (id INT AUTO_INCREMENT NOT NULL, revenue_id INT NOT NULL, user_id INT NOT NULL, amount NUMERIC(12, 2) NOT NULL, category VARCHAR(100) NOT NULL, expense_date DATE NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_2D3A8DA6224718EB (revenue_id), INDEX IDX_2D3A8DA6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE investissement (id INT AUTO_INCREMENT NOT NULL, crypto_id INT DEFAULT NULL, objectif_id INT DEFAULT NULL, user_id INT DEFAULT NULL, amount_invested NUMERIC(12, 2) NOT NULL, buy_price NUMERIC(20, 8) NOT NULL, quantity DOUBLE PRECISION NOT NULL, created_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_B8E64E01E9571A63 (crypto_id), INDEX IDX_B8E64E01157D1AD4 (objectif_id), INDEX IDX_B8E64E01A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objectif (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, target_multiplier DOUBLE PRECISION NOT NULL, initial_amount NUMERIC(12, 2) NOT NULL, target_amount NUMERIC(12, 2) NOT NULL, is_completed TINYINT(1) NOT NULL, created_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', UNIQUE INDEX UNIQ_E2F868515E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, cours_id INT DEFAULT NULL, user_id INT DEFAULT NULL, question LONGTEXT NOT NULL, choix_reponses LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', reponse_correcte VARCHAR(100) NOT NULL, points_valeur INT NOT NULL, INDEX IDX_A412FA927ECF78B0 (cours_id), INDEX IDX_A412FA92A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, admin_responder_id INT DEFAULT NULL, subject VARCHAR(160) NOT NULL, message LONGTEXT NOT NULL, admin_response LONGTEXT DEFAULT NULL, status VARCHAR(30) NOT NULL, contains_bad_words TINYINT(1) DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', resolved_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_CE606404A76ED395 (user_id), INDEX IDX_CE6064044E78F836 (admin_responder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recurring_transaction_rule (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, expense_revenue_id INT DEFAULT NULL, kind VARCHAR(10) NOT NULL, frequency VARCHAR(20) NOT NULL, amount NUMERIC(12, 2) NOT NULL, label VARCHAR(255) NOT NULL, signature VARCHAR(80) NOT NULL, next_run_at DATE NOT NULL, is_active TINYINT(1) NOT NULL, confidence DOUBLE PRECISION DEFAULT NULL, expense_category VARCHAR(100) DEFAULT NULL, revenue_type VARCHAR(20) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F0CE0F4DA76ED395 (user_id), INDEX IDX_F0CE0F4D925327E2 (expense_revenue_id), UNIQUE INDEX uniq_recurring_user_signature (user_id, signature), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE revenue (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, amount NUMERIC(12, 2) NOT NULL, type VARCHAR(20) NOT NULL, received_at DATE NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_E9116C85A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
